...
return [
    ...
    */
    ...
    'public' => [
//        'oauth_access_tokens' => [
//            'parent' => App\Models\BaseModel\BaseOauthAccessToken::class,
//        ],
//        'oauth_auth_codes' => [
//            'parent' => App\Models\BaseModel\BaseOauthAuthCode::class,
//        ],
//        'oauth_clients' => [
//            'parent' => App\Models\BaseModel\BaseOauthClient::class,
//        ],
//        'oauth_personal_access_clients' => [
//            'parent' => App\Models\BaseModel\BaseOauthPersonalAccessClient::class,
//        ],
//        'oauth_refresh_tokens' => [
//            'parent' => App\Models\BaseModel\BaseOauthRefreshToken::class,
//        ],
        'users' => [
            'parent' => App\Models\BaseModel\BaseUserModel::class,
            'use' => [
                HasUuidRouteKey::class,
            ],
        ],
    ],
    'agent_strings' => [
    ...
    'tags' => [
        'tags' => [
            'parent' => App\Models\BaseModel\BaseModel::class,
            'use' => [
                Kalnoy\Nestedset\NodeTrait::class,
            ],
        ],
    ],
